...
export default function Example() {
  return (
<div>
    <div className="bg-white shadow shadow-gray-500 overflow-hidden sm:rounded-lg mx-8 my-20">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">User's Information</h3>
        <p className="mt-1 max-w-2xl text-sm text-gray-500">Personal details of our respected User.</p>
      </div>
